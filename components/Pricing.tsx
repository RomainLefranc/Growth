  ...
  return (
    <section className="my-20">
      <div className="mx-auto max-w-[800px] px-4">
        <h3 className="mb-6 mt-10 text-center text-5xl leading-[1.2]">Pricing</h3>
        <p className="mb-16 mt-6 text-center text-lg leading-[1.4] md:text-xl">Start free and scale while you grow. No hidden fees. Unlimited users for free.</p>
        <div className="grid grid-cols-1 items-center gap-5 md:grid-cols-2">
          <div className="rounded-2xl bg-light p-14">
            <div>
              <h4 className="mb-4 text-3xl sm:text-4xl">Simple</h4>
              <p className="mb-8">Keep track of your contacts, gain valuable insights, analyse live data and performance metrics.</p>
            ...
            <div>
              ...
              <Link href="#" className="mt-8 block w-full rounded-2xl bg-primary py-4 text-center font-medium text-white duration-500 hover:opacity-80">
                Get Started
              </Link>
            </div>
          </div>
          ...
          <div className="rounded-2xl bg-black p-14 text-white">
            <div>
              ...
              <p className="mb-8">Keep track of your contacts, gain valuable insights, analyze live data and performance metrics.</p>
